  ...
  <main className="container">
    <form>
      <div className="form-group">
        ...
        <input type="text" id="name" className="form-control" placeholder="Enter page name..." defaultValue="Blog Post" />
      </div>
      <div className="form-group">
        <label htmlFor="title">Title</label>
        <input type="text" id="title" className="form-control" placeholder="Enter page title..." />
      </div>
