    ...
    <div>
      ...
      <main className="container-fluid">
        ...
        <section>
          ...
          <h3>
            Volunteers In Roxbury Help Hundreds Of Immigrants Apply For
            Citizenship.
          </h3>
        </section>
        <section>
          ...
          <img
            src="https://i.iheart.com/v3/re/new_assets/03c05165-07ad-4512-af23-4d325d2ff34c?ops=max(650,0),quality(80)"
            alt="volunteers"
            width="100%"
          />
        </section>
        <section>
          ...
          <p>
            BOSTON{" "}
            <a href="https://wbznewsradio.iheart.com/">(WBZ NewsRadio)</a> —
            Saturday was Citizenship Day in Boston. Volunteers helped more than
            400 immigrants apply to become citizens in Roxbury.
          </p>
        </section>
        <section>
          <div className="position-absolute absolute-right p-1 bg-light rounded-left">
        ...
        <section>
          ...
          <p>
            In touring the neighborhood, Bob introduces the nine-unit Roxbury
